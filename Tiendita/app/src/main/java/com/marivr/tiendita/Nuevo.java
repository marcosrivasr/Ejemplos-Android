...
public class Nuevo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bCrear = (FloatingActionButton) findViewById(R.id.bCrear);
        ...
        bTomar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               verifyTakePicturePermissions(Nuevo.this);
            }
        });
        ...
        bCrear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                crud.crearNuevoElemento(
                        new Producto(etNombre.getText().toString(), urlName, precio));
                Toast.makeText(Nuevo.this, "Nuevo elemento creado", Toast.LENGTH_SHORT).show();
